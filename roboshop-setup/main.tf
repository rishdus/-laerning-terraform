...
resource "null_resource" "ansible-apply" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "sudo labauto clean",
      "sudo ansible-pull -i localhost, -U https://github.com/rishdus/roboshop-mutable-ansible.git roboshop.yml -e HOSTS=localhost -e APP_COMPONENT_ROLE=${var.components[count.index]} -e ENV=dev"
    ]
